...
public class p31_Number0to100 {
    public static void main(String[] args) {
       ...
       if (num == 0){
           ...
           System.out.println("thirty tree");
       }else if (num == 34){
           ...
           System.out.println("seventy tree");
       }else if (num == 74){
           ...
           System.out.println("eighty tree");
       }else if (num == 84){
           ...
           System.out.println("ninety tree");
       }else if (num == 94){
